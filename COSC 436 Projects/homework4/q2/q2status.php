...
setcookie("credits", $credits, time()+60 * 10);
?>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div id = "calc">
            <h2>Step 2: Status</h2>
            <form method = "post" action = "http://localhost/q2state.php">
                <input type = "radio" name = "rad" value = "ugrad">Undergrad</input>
                <input type = "radio" name = "rad" value = "grad">Graduate</input>
                <br>
                <input type = "submit">
            </form>
        </div>
