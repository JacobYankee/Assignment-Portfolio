...
//This tester has parameters for the contents of file02
public class NeuralNetworkTester1B
{
    //Main method
    public static void main(String[] args) throws IOException
    {
        ...
        //normalize data
        network.normalize();    //ask about this

        //set parameters of network, get seed in tester
        int seed = network.setParameters(3, 50000, 0.2, 7500);
