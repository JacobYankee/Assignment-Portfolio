...
public class Bayes
{
    ...
    throws IOException
    {
         ...
         //write number of records and a new line for formatting
         ...
         for (int i = 0; i < numberRecords; i++)
         {
             ...
             //write class name converted from number to name
             outFile.println(convertNumberToClass(className));
             outFile.flush();
         }
    ...
    public double validate(String validationFile) throws IOException
    {
         ...
         //read number of records
         int numberRecords = inFile.nextInt() -1;
         //Skip over line in training file containing the number of attribute values
         inFile.nextLine();
         inFile.nextLine();
    ...
    public void lOOValidation(String trainingFile, int value) throws FileNotFoundException
    {
        Scanner inFile = new Scanner(new File(trainingFile));
        ...
        //Read the number of attribute values
        attributeValues = new int[numberAttributes];
        for(int i = 0; i < numberAttributes; i++)
        {
            attributeValues[i] = inFile.nextInt();
        ...
        //Create an empty arraylist of records
        records = new ArrayList<Record>();
        ...
        for (int i = 0; i < numberRecords; i++)
        {
            ...
            //Add the record to the lsit of records
            records.add(record);
        }
